 <template>
    <div class="bg-white position-relative container-background-wrapper">
      <footer class="footer" >
            ...
            <div class="row">
              ...
              <div class="col-xl-8 col-lg-9 col-md-10 col-12">
                <div class="row justify-content-between">
                  <div class="col-lg-auto col-md-auto footer-content mb-3 mb-md-0 pr-md-0 pr-lg-3">
                    <template>
                      <a href="#" class="link-title title-header">
                  ...
                  <div class="col-lg-auto col-md-auto footer-content">
                    ...
                    <figure>  
                      <prismic-link  target="_blank" class="link-title">
                        <span class="footer-soical-icon d-inline-block text-center"> 
                            <!-- <img :src="item.social_media_icon.url" width="14" height="14"/> -->
                        </span>
        ...
        <div  class="bottom-bar">
          <div class="row footer-bottom px-0 text-left text-md-left m-0 mt-xl-5 pb-xl-4 pt-xl-4">
            <div class="col-md-6 footer-copyright">
              <span class="logo-right-text"></span>
            </div>
 ...
 <!-- <script>
  ...
  export default {
    ...
    methods: {
      ...
      //     .then((footerContent) => { */
      //         let footerContent = this.$store.state.menu
