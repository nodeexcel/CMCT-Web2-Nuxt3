...
// EXTERNAL MODULE: ./node_modules/@prismicio/vue/dist/usePrismic.js
var usePrismic = __webpack_require__(7784);
...
/* harmony default export */ const previewvue_type_script_setup_true_lang_js = ({
  __name: 'preview',
...
const __exports__ = /*#__PURE__*/(0, exportHelper/* default */.Z)(previewvue_type_script_setup_true_lang_js, [['__scopeId',"data-v-eaf72740"]]);

/* harmony default export */ const preview = (__exports__);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.prismic-preview[data-v-eaf72740]{align-items:center;background:#fff;color:#666;display:flex;font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen,Ubuntu,Cantarell,Open Sans,Helvetica Neue,sans-serif;font-size:1rem;height:100vh;justify-content:center;left:0;position:fixed;text-align:center;top:0;width:100%}img[data-v-eaf72740]{margin-bottom:1.25rem}`, ""]);
// Exports
